...
class CoursesListPage(BasePage):
    ...
    def check_visible_create_course_title(self):
        expect(self.create_course_title_text).to_be_visible()
    ...
    def check_visible_image_preview_empty_view(self):
        ...
        expect(self.create_course_empty_view_title).to_be_visible()
        expect(self.create_course_empty_view_title).to_have_text('No image selected')
